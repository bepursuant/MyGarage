// takes an input file and a viewname and create a file
// with a PROGMEM statement that contains the original
// html, fully escaped. useful for static web content
...
int main(int argc, char* argv[])
{
	...
	if (argc<3) {
		printf("Usage: %s inputFileName viewName\n", argv[0]);
		return 0;
	}
