...
<form id="connect_form" action="/auth" method="POST" class="form">
<fieldset>
...
<small>
<b class="lbl_status">Unknown</b> at <b class="lbl_time">2017-01-01 00:00:00</b>
</small>
<br />
<button id="door-button" class="btn btn-a">Toggle</button>
</div>
...
<!-- CONFIGURATION FORM -->
<form id="config_form" name="config_form" action="/json/config" method="POST" class="form">
...
<input type="submit" name="config_submit" value="Update Configuration" class="btn btn-a btn-sm" />
</form>
...
$("#smtp_notify_boot").prop("checked", config.smtp_notify_boot ? 1 : 0);
$("#smtp_notify_status").prop("checked", config.smtp_notify_status ? 1 : 0);
