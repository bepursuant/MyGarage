...
<h4 class="ui dividing header">Email Status Notifications</h4>
...
<label>Send Email on Door Status Change</label>
</div>
</label>
</div>

<div class="twelve wide field">
<label>Door Status Change Email Subject</label>
<input type="text" id="smtp_notify_status_subject" name="smtp_notify_status_subject" />
</div>

<div class="twelve wide field">
<label>Door Status Change Email Body</label>
...
<label>Send Email on Boot/Reboot</label>
</div>
</label>
</div>

<div class="twelve wide field">
<label>Boot/Reboot Email Subject</label>
<input type="text" id="smtp_notify_boot_subject" name="smtp_notify_boot_subject" />
</div>

<div class="twelve wide field">
<label>Boot/Reboot Email Body</label>
